...
//	}
    ...
    Connection(boost::asio::io_context& io_context) : socket_(io_context), io_service(io_context) {
...
//            boost::asio::io_context().get_executor().context().post(boost::bind(handler, error));
//            boost::asio::execution_context& ioc = socket_.get_executor().context();
//            boost::asio::post(ioc, boost::bind(handler, error));
//            socket().get_executor().context().post(boost::bind(handler, error));
			return;
		}	
